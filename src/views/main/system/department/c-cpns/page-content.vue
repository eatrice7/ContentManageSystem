<template>
  <div class="content">
    <div class="header">
      ...
      <el-button type="primary" @click="handleNewUserClick" v-if="isCreate">新建部门</el-button>
    </div>
    <div class="table">
      <el-table :data="pageList" stripe style="width: 100%">
        ...
        <el-table-column prop="leader" label="部门领导" width="140" align="center" />
        <el-table-column prop="parentId" label="上级部门" width="160" align="center" />
...
function handleDeleteBtnClick(id: number) {
  systemStore.deletePageByIdAction('department', id).then((res) => {
    ElMessage({
      message: res.data,
